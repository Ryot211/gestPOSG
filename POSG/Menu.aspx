<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNuevo.master" AutoEventWireup="true" CodeFile="Menu.aspx.cs" Inherits="POSG_Menu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-3 mb-3">
                <div class="menu-option text-center p-4 rounded shadow-sm" onclick="location.href='POSG_Inscripciones.aspx'">
                    ...
                    <h4 class="text-uppercase font-weight-bold">Secretario Academico</h4>
                </div>
            </div>
        ...
        <div  class="row justify-content-left">
             <div class="col-md-3 mb-3">
                <div class="menu-option text-center p-4 rounded shadow-sm" onclick="location.href='POSG_ListadoEstudiantes.aspx'">
                    <i class="fa fa-university" aria-hidden="true"></i>
                    <h4 class="text-uppercase font-weight-bold">Coordinador</h4>
                </div>
            </div>
             <div class="col-md-3 mb-3">
                <div class="menu-option text-center p-4 rounded shadow-sm" onclick="location.href='POSG_Inscripciones.aspx'">
                    <i class="fa fa-user-circle" aria-hidden="true"></i>
                    <h4 class="text-uppercase font-weight-bold">Tutor Academico</h4>
                </div>
            </div>
