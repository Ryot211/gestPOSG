...
public partial class POSG_POSG_DOCENTE1 : System.Web.UI.Page
{
    ...
    protected void gvwDocente_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      gvwDocente.SelectedDataKey["strNomb_per"].ToString(),
      gvwDocente.SelectedDataKey["strApellidop_per"].ToString(),
      gvwDocente.SelectedDataKey["strApellidom_per"].ToString()); txtTribunal.Text = nombreCompleto;
        ScriptManager.RegisterStartupScript(this, this.GetType(), "ShowModal", "$('#modalTribunal').modal('show');", true);
    }
