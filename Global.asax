...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        // en la aplicación.
        // Consulte http://go.microsoft.com/fwlink/?LinkId=257395 para obtener más información sobre cómo registrar el modelo de datos de entidad con datos dinámicos            
